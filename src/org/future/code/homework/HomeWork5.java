   ...
   */
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            // uncomment if u want to see exception (else code is stopped)
//            person.takeDamage(DAMAGE1);
        } catch (PersonDead e) {
...
//            mage.takeDamage(DAMAGE2);
            test("Всё отлично работает, посмотрите пожалуйста код и комментарии \uD83E\uDD14", true);
            mage.emotion(MAGE_NAME);
            thirdCheck = true;
//        } catch (PersonDead e) {
//            thirdCheck = true;
//        }
...
class Mage extends Person {
 ...
 class ExceptionForHealth extends Exception {
    public ExceptionForHealth(String message) {
        super(message);
    }
}
 class ExceptionForDamage extends Exception {
